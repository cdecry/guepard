...
(function () {
  ...
  flash.utils.test = function () {
    ...
    flash.trace(
      "getDefinitionByName = " +
        flash.utils.getDefinitionByName("flash.utils.Timer"),
    );
    flash.trace(
      "getQualifiedClassName = " +
        flash.utils.getQualifiedClassName(new flash.utils.Timer()),
    );
    flash.trace(
      "getQualifiedSuperclassName = " +
        flash.utils.getQualifiedSuperclassName(new flash.utils.Timer()),
    );

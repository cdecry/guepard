...
(function () {
  ...
  d.get_currentScene = function () /*Scene*/
  {
    for (var i = 0; i < this._scenes.length; i++) {
      ...
      if (
        scene._offset <= this._currentFrame &&
  ...
  d.__frameProcessing__ = function () {
    while (this._oldFrame != this._currentFrame) {
      ...
      if (this.hasEventListener(flash.events.Event.FRAME_CONSTRUCTED)) {
        this.dispatchEvent(
          new flash.events.Event(flash.events.Event.FRAME_CONSTRUCTED),
        );
      }
  ...
  s.__init__ = function () {
    ...
    /*super*/
    /*public*/
    this.prototype.Sprite___updateMovieClipList__ =

...
(function () {
  ...
  /*public*/
  d.GraphicsGradientFill = function (
    param1 /*String*/,
    param2 /*Array*/,
    param3 /*Array*/,
    param4 /*Array*/,
    ...
    if (
      this._interpolationMethod != flash.display.InterpolationMethod.LINEAR_RGB
    ) {
    }
  ...
  flash.addDescription("flash.display.GraphicsGradientFill", d, null, null, [

...
(function () {
  ...
  d.copyChannel = function (
    ...
    var sourceData = sourceBitmapData._context2d.getImageData(
      sourceRect.x,
      sourceRect.y,
      sourceRect.width,
      sourceRect.height,
    ...
    var destData = this._context2d.getImageData(
      destPoint.x,
      destPoint.y,
      sourceRect.width,
      sourceRect.height,
  ...
  d.copyPixels = function (
    ...
    if (!sourceRect) {
      sourceRect = new flash.geom.Rectangle(
        0,
        0,
        sourceBitmapData.width,
        sourceBitmapData.height,
      );
    }
    ...
    var dataCopy = sourceContext.getImageData(
      sourceRect.x,
      sourceRect.y,
      sourceRect.width,
      sourceRect.height,
  ...
  d.draw = function (
    ...
    if (clipRect == undefined)
      clipRect = new flash.geom.Rectangle(
        0,
        0,
        this._rect.width,
        this._rect.height,
  ...
  /*public*/
  d.getColorBoundsRect = function (
    mask /*uint*/,
    color /*uint*/,
    findColor /*Boolean*/ /*Rectangle*/,
  ) {
  ...
  d.hitTest = function (
    ...
    secondAlphaThreshold /*uint*/ /*Boolean*/,
  ) {
  ...
  /*public*/
  d.setPixels = function (
    rect /*Rectangle*/,
    inputByteArray /*ByteArray*/ /*void*/,
  ) {};
  ...
  d._getTransfomedCanvas = function (map, colorTransform, filters) {
    ...
    if (this._cTransformedAtlas[id] != value) {
      ...
      var imagedata = this._context2d.getImageData(
        map.x,
        map.y,
        map.width,
        map.height,
  ...
  flash.addDescription("flash.display.BitmapData", d, null, s, [

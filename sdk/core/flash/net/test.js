(function () {
  ...
  flash.net.test = function () {
    ...
    flash.trace(
      "flash.net.URLRequestMethod.GET = " + flash.net.URLRequestMethod.GET,
    );
    flash.trace(
    ...
    flash.trace(
      "new flash.net.URLRequestHeader() = " +
        new flash.net.URLRequestHeader("name", "value"),
    );
    flash.trace(
      "flash.net.SharedObject.getLocal() = " +
        flash.net.SharedObject.getLocal("test"),
    );
    flash.trace(
      "new flash.net.URLVariables('a=10&b=test') = " +
        new flash.net.URLVariables("a=10&b=test"),
    );
    ...
    loader.addEventListener(
      ...
      flash.bindFunction(obj, obj.loadComplete),
    );

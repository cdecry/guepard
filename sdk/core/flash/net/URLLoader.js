...
(function () {
  ...
  d.load = function (request /*URLRequest*/ /*void*/) {
    ...
    this._jsRequest.addEventListener(
      "readystatechange",
      flash.bindFunction(this, this._statusChange),
      false,
    );

    this._jsRequest.addEventListener(
      "progress",
      flash.bindFunction(this, this._updateProgress),
      false,
    );
    this._jsRequest.addEventListener(
      "load",
    ...
    if (
      this.dataFormat == flash.net.URLLoaderDataFormat.TEXT ||
  ...
  d._complete = function (e) {
    ...
    this.dispatchEvent(
      new flash.events.HTTPStatusEvent(

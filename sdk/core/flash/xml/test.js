(function () {
  ...
  flash.xml.test = function () {
    ...
    var child1 = new flash.xml.XMLNode(
      flash.xml.XMLNodeType.ELEMENT_NODE,
      "child1",
    );

    var node = new flash.xml.XMLNode(
      flash.xml.XMLNodeType.ELEMENT_NODE,
      "test",
    );
    ...
    node.appendChild(
      new flash.xml.XMLNode(flash.xml.XMLNodeType.ELEMENT_NODE, "child2"),
    );
    node.appendChild(
      new flash.xml.XMLNode(flash.xml.XMLNodeType.ELEMENT_NODE, "child3"),
    );
    ...
    s =
      '<SWFData color="0xffffff" frameRate="30" height="400" version="10" width="600">';
    s += "<FileAttributes/>";
    s += "<Metadata/>";
    ...
    s +=
      '<Rectangle height="45" name="bounds" width="43.85" x="-21.9" y="-22.5"/>';

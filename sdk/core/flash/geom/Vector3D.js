...
(function () {
  ...
  /*public*/
  d.crossProduct = function (
    a /*flash.geom.Vector3D*/ /*flash.geom.Vector3D*/,
  ) {
    return null;
  };
  ...
  s.__init__ = function () {
    /*public*/
    this /*const*/.X_AXIS /*flash.geom.Vector3D*/ = new flash.geom.Vector3D(
      1,
      0,
      0,
    );
    /*public*/
    this /*const*/.Y_AXIS /*flash.geom.Vector3D*/ = new flash.geom.Vector3D(
      0,
      1,
      0,
    );
    /*public*/
    this /*const*/.Z_AXIS /*flash.geom.Vector3D*/ = new flash.geom.Vector3D(
      0,
      0,
      1,
    );
  ...
  /*public*/
  s.angleBetween = function (
    a /*flash.geom.Vector3D*/,
    b /*flash.geom.Vector3D*/ /*Number*/,
  ) {
    return 0;
  };
  ...
  /*public*/
  s.distance = function (
    pt1 /*flash.geom.Vector3D*/,
    pt2 /*flash.geom.Vector3D*/ /*Number*/,
  ) {
    return 0;
  };

  flash.addDescription("flash.geom.Vector3D", d, null, s, null, [
    "flash.geom.Vector3D",
  ]);
})();

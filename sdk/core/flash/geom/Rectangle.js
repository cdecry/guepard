...
(function () {
  ...
  d.intersection = function (rect /*Rectangle*/ /*Rectangle*/) {
    ...
    result.width =
      Math.min(this.x + this.width, rect.x + rect.width) - result.x;
    result.height =
      Math.min(this.y + this.height, rect.y + rect.height) - result.y;
  ...
  d.intersects = function (rect /*Rectangle*/ /*Boolean*/) {
    ...
    var width /*Number*/ =
      Math.min(this.x + this.width, rect.x + rect.width) - x;

    if (width <= 0) return false;

    var y /*Number*/ = Math.max(this.y, rect.y);
    var height /*Number*/ =
      Math.min(this.y + this.height, rect.y + rect.height) - y;
  ...
  d.union = function (rect /*Rectangle*/ /*Rectangle*/) {
    ...
    result.width =
      Math.max(this.x + this.width, rect.x + rect.width) - result.x;
    result.height =
      Math.max(this.y + this.height, rect.y + rect.height) - result.y;

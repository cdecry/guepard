...
(function () {
  ...
  {
    return this.get_relatedObject()
      ? this.get_relatedObject()
      : this.get_target();
  };
  ...
  {
    return new flash.events.TouchEvent(
      this.get_type(),
      this.get_bubbles(),
      this.get_cancelable(),
      this.m_touchPointID,
      this.m_isPrimaryTouchPoint,
      this.get_localX(),
      this.get_localY(),
      this.m_sizeX,
      this.m_sizeY,

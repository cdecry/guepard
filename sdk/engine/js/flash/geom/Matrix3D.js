...
(function () {
  ...
  d.appendRotation = function (
    degrees /*Number*/,
    axis /*flash.geom.Vector3D*/,
    pivotPoint /*flash.geom.Vector3D*/ /*void*/,
  ) {
    if (pivotPoint == undefined) pivotPoint = null;
  };

  d.appendScale = function (
    xScale /*Number*/,
    yScale /*Number*/,
    zScale /*Number*/ /*void*/,
  ) {};

  d.appendTranslation = function (
    x /*Number*/,
    y /*Number*/,
    z /*Number*/ /*void*/,
  ) {};
  ...
  d.copyColumnFrom = function (
    column /*uint*/,
    vector3D /*flash.geom.Vector3D*/ /*void*/,
  ) {
    column = /*uint*/ Math.floor(column);
  };

  d.copyColumnTo = function (
    column /*uint*/,
    vector3D /*flash.geom.Vector3D*/ /*void*/,
  ) {
    column = /*uint*/ Math.floor(column);
  ...
  d.decompose = function (
    orientationStyle /*String*/ /*Vector.<flash.geom.Vector3D>*/,
  ) {
  ...
  d.deltaTransformVector = function (
    v /*flash.geom.Vector3D*/ /*flash.geom.Vector3D*/,
  ) {
    return null;
  };
  ...
  d.interpolateTo = function (
    toMat /*flash.geom.Matrix3D*/,
    percent /*Number*/ /*void*/,
  ) {};
  ...
  d.pointAt = function (
    pos /*flash.geom.Vector3D*/,
    at /*flash.geom.Vector3D*/,
    up /*flash.geom.Vector3D*/ /*void*/,
  ) {
  ...
  d.prependScale = function (
    xScale /*Number*/,
    yScale /*Number*/,
    zScale /*Number*/ /*void*/,
  ) {};

  d.prependTranslation = function (
    x /*Number*/,
    y /*Number*/,
    z /*Number*/ /*void*/,
  ) {};

  d.recompose = function (
    components /*Vector.<flash.geom.Vector3D>*/,
  ...
  d.transformVector = function (
    v /*flash.geom.Vector3D*/ /*flash.geom.Vector3D*/,
  ) {
    return null;
  };

  d.transformVectors = function (
    vin /*Vector.<Number>*/,
  ...
  s.interpolate = function (
    thisMat /*flash.geom.Matrix3D*/,
    toMat /*flash.geom.Matrix3D*/,
    percent /*Number*/ /*flash.geom.Matrix3D*/,
  ) {
    return null;
  };

...
(function () {
  ...
  d.Stage = function (canvasId, rendermode, width, height) {
    ...
    this._bindedRAFC = flash.bindFunction(
      this,
      this._requestAnimationFrameComplete,
    );
  ...
  d._initEvents = function () {
    ...
    if (this._canvas) {
      this._canvas.addEventListener(
        "mousemove",
        flash.bindFunction(this, this._mousevent),
        false,
      );
      this._canvas.addEventListener(
        "mousedown",
      ...
      window.addEventListener(
        "keydown",
        flash.bindFunction(this, this._keyevent),
        false,
      );
      window.addEventListener(
        "keyup",
  ...
  d._getMousePoint = function (x, y) {
    return this._render._invertedMatrix.transformPoint(
  ...
  /*override*/
  d.set_accessibilityImplementation = function (
    value /*AccessibilityImplementation*/ /*void*/,
  ) {
    return;
  };

  /*override*/
  d.set_accessibilityProperties = function (

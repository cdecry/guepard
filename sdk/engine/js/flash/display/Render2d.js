(function () {
      ...
      if (filters.length > 0) {
        for (var i in filters) {
          ...
          if (flash.is(filter, flash.filters.DropShadowFilter)) {
            ...
            this._currentcontext.shadowOffsetX =
              Math.cos(filter.get_angle()) * filter.get_distance();
            this._currentcontext.shadowOffsetY =
              Math.sin(filter.get_angle()) * filter.get_distance();
  ...
  d.startMask = function (mask) {
    ...
    this._maskBounds.x =
      this._baseMatrix.tx + this._maskBounds.x * this._baseMatrix.a;
    this._maskBounds.y =
      this._baseMatrix.ty + this._maskBounds.y * this._baseMatrix.d;
    this._maskBounds.width =
      ratio * this._maskBounds.width * this._baseMatrix.a;
    this._maskBounds.height =
      ratio * this._maskBounds.height * this._baseMatrix.d;
  ...
  d.stopMask = function () {
    if (this._currentcontext == this._maskedCanvasContext) {
      ...
      if (this._maskBounds.get_bottom() > this._height)
        this._maskBounds.set_bottom(this._height);
      ...
      this._maskedCanvasContext.drawImage(
        this._maskCanvas,
        mx,
        my,
        mw,

...
(function () {
  ...
  d.addChildAt = function (
    ...
    if (this.get_stage()) {
      child.dispatchEvent(
        new flash.events.Event(flash.events.Event.ADDED_TO_STAGE),
      );
    }
  ...
  d.removeChildAt = function (index /*int*/ /*DisplayObject*/) {
    ...
    if (this.get_stage()) {
      child.dispatchEvent(
        new flash.events.Event(flash.events.Event.REMOVED_TO_STAGE),
      );
    }
  ...
  d.setChildIndex = function (child /*DisplayObject*/, index /*int*/ /*void*/) {
    ...
    if (this.contains(child)) {
      ...
      console.error(
        "can not change the index of the object that does not contains in container",
      );
    }
  };

  d.swapChildren = function (
  ...
  d.dispatchEvent = function (event /*Event*/ /*Boolean*/) {
    ...
    if (
      type == flash.events.Event.ADDED_TO_STAGE ||
      ...
      if (target) {
        ...
        if (dispatch) {
          this._dispatchInteractiveEvent(
            ...
            point.x,
            point.y,
            this._mouseChildren ? target : this,
          );
        }
      } else {
        point = this.InteractiveObject__updateInteractiveEvent(
          data,
          dispatch,
          true,
        );
  ...
  s.__init__ = function () {
    ...
    /*super*/
    this.prototype.InteractiveObject_getBounds =
      this.__base__.prototype.getBounds;
    /*super*/
    this.prototype.InteractiveObject_dispatchEvent =
      this.__base__.prototype.dispatchEvent;
    /*super*/
    this.prototype.InteractiveObject___updateMovieClipList__ =
      this.__base__.prototype.__updateMovieClipList__;
    /*super*/
    this.prototype.InteractiveObject__updateInteractiveEvent =
      this.__base__.prototype._updateInteractiveEvent;
  };

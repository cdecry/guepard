...
(function () {
  ...
  d._renderData = function () {
    if (this._needsRender) {
      ...
      if (this._canvasRect != null) {
        ...
        var textureHeight = flash.getTextureSize(
          this._canvasRect.height * scale,
        );
  ...
  d.beginBitmapFill = function (
    ...
    if (bitmap) {
      var fill = new flash.display.GraphicsBitmapFill(
        bitmap,
        matrix,
        repeat,
        smooth,
    ...
    if (bounds) {
      ...
      if (bounds.containsPoint(this._checkTouch_point)) {
        if (this._textureInfo) {
          ...
          var bitmapX = Math.floor(
            (this._checkTouch_point.x - bounds.x) * scale,
          );
          var bitmapY = Math.floor(
            (this._checkTouch_point.y - bounds.y) * scale,
          );

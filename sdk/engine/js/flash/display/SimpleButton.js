...
(function () {
  ...
  d.set_hitTestState = function (value /*DisplayObject*/ /*void*/) {
    ...
    if (this._hitTestState) {
      ...
      this._hitTestState.removeEventListener(
        flash.events.MouseEvent.MOUSE_OVER,
        flash.bindFunction(this, this._mouseOver),
      );
      this._hitTestState.removeEventListener(
        flash.events.MouseEvent.MOUSE_OUT,
        flash.bindFunction(this, this._mouseOut),
      );
      this._hitTestState.removeEventListener(
        flash.events.MouseEvent.MOUSE_DOWN,
        flash.bindFunction(this, this._mouseDown),
      );
      this._hitTestState.removeEventListener(
        flash.events.MouseEvent.MOUSE_UP,
        flash.bindFunction(this, this._mouseUp),
      );
    }

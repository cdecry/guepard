(function () {
  ...
  d.parseColorTransform = function (node) {
    ...
    if (attributes.redMultiplier)
      colorTransform.redMultiplier = Number(attributes.redMultiplier);
    if (attributes.greenMultiplier)
      colorTransform.greenMultiplier = Number(attributes.greenMultiplier);
    if (attributes.blueMultiplier)
      colorTransform.blueMultiplier = Number(attributes.blueMultiplier);
    if (attributes.alphaMultiplier)
      colorTransform.alphaMultiplier = Number(attributes.alphaMultiplier);

    if (attributes.redOffset)
      colorTransform.redOffset = Number(attributes.redOffset);
    if (attributes.greenOffset)
      colorTransform.greenOffset = Number(attributes.greenOffset);
    if (attributes.blueOffset)
      colorTransform.blueOffset = Number(attributes.blueOffset);
    if (attributes.alphaOffset)
      colorTransform.alphaOffset = Number(attributes.alphaOffset);

...
(function () {
  ...
  /*public*/ d.Vertex = function (x /*Number*/, y /*Number*/, z /*Number*/) {
    ...
    flash.utils.setTimeout(
      flash.bindFunction(function () /*void*/
      {
        this.x = 10;
      }, this),
      1000,
  ...
  /*public*/ d.subtract = function (
    vertex /*com.guepard.tests.Vertex*/ /*void*/,
  ) {
    this.x -= vertex.x;
    this.y -= vertex.y;
    this.z -= vertex.z;
  ...
  /*public*/ s.distance = function (
    vertex0 /*com.guepard.tests.Vertex*/,
    vertex1 /*com.guepard.tests.Vertex*/ /*Number*/,
  ) {
    var dx /*Number*/ = 0;
    var dy /*Number*/ = 0;
    var dz /*Number*/ = 0;
  ...
  flash.addDescription(
    "com.guepard.tests.Vertex",
    d,
    null,
    s,
    ["com.guepard.tests.IExample"],
    null,
  );
})();

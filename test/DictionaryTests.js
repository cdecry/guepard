...
(function () {
  ...
  /*public*/ d.DictionaryTests = function () {
    ...
    this._dict.setProperty(
      this._dict.getProperty(flash.geom.Matrix),
      flash.geom.Matrix,
    );
    this._dict.setProperty(
      this._dict.getProperty(flash.geom.Point),
      flash.geom.Point,
    );
  };
  ...
  flash.addDescription("com.guepard.tests.DictionaryTests", d, null, s, null, [
    "com.guepard.tests.DictionaryTests",
    "flash.geom.Matrix",
    "flash.geom.Point",
  ]);
})();

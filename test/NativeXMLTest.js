...
(function () {
  ...
  /*public*/ d.NativeXMLTest = function () {
    this.xml1 = new XML(
      "<test x='1' y=\"2\" name=\"superman 'bla bla bla' \'symbol\' \"/>",
    );
    this.xml2 = new XML(
      '<root name="superman">									<!-- This Is XML Comment -->									<item value="1"/>									<item value="2">This is Text</item>									<item value="3">										<sub text=""></sub>										<item value="2211"/>									</item>								</root>',
    );
    ...
    flash.trace(
      "xml2.item[0].toXMLString()",
      this.xml2.child("item")[0].toXMLString(),
    );
    flash.trace(
      "xml2.child('item')[0].@value",
      this.xml2.child("item")[0].attribute("value"),
    );
    flash.trace(
      "xml2.item[0].@value",
      this.xml2.child("item")[0].attribute("value"),
    ...
    flash.trace(
      "xml2..item[3].@value",
      this.xml2.descendants("item")[3].attribute("value"),
    );
    flash.trace(
      "xml2.descendants('item')[3].attribute('value')",
      this.xml2.descendants("item")[3].attribute("value"),
    );
    xml = new XML("<root/>");
  ...
  /*private*/ d.testCondition = function () /*void*/
  {
    ...
    myXML = new XML(
      "<order> 					<item id='1'> 						<menuName>burger</menuName> 						<price>3.95</price> 					</item> 					<item id='2'> 						<menuName>fries</menuName> 						<price>1.45</price> 					</item> 				</order>",
    );
    flash.trace(
      "myXML.item[0].menuName",
      myXML.child("item")[0].child("menuName"),
    );
    flash.trace(
      "myXML.item.(@id==2).menuName",
      myXML
        .child("item")
        .__find__(function (t0 /*XML*/ /*Boolean*/) {
          return /*int*/ flash.int(t0.attribute("id")) == 2;
        })
        .child("menuName"),
    );
    flash.trace(
      "myXML.item.(menuName=='burger').price",
      myXML
        .child("item")
        .__find__(function (t0 /*XML*/ /*Boolean*/) {
  ...
  /*public*/ d.testBug = function (ioXMLNode /*XML*/ /*void*/) {
    ...
    throw new Error(
      'genHScrollBar error: constructor method position argument requires either "top" (genHScrollBar.TOP) or "bottom" (genHScrollBar.BOTTOM).',
    );
  };

  flash.addDescription(
    "com.guepard.tests.NativeXMLTest",
    d,
    null,
    null,
    null,

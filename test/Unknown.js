...
(function () {
  ...
  /*private*/ d.parametersAndLocals = function (
    param1 /*Number*/,
    param2 /*String*/,
    param3 /*Array*/ /*String*/,
  ) {
    ...
    v.set_unknown(10);
    tmp = com.guepard.tests.Unknown.get_instance()
      .unknown5.clone()
      .get_length();
    return n + i + s;
  };

  /*private*/ d.arrays = function (
    classes /*Vector.<Class>*/,
    instances /*Vector.<flash.display.DisplayObject>*/,
    interfaces /*Vector.<flash.display.IBitmapDrawable>*/,
    multy /*Vector.<Vector.<Vector.<Boolean>>>*/ /*void*/,
  ) {
    ...
    instances = [
      ...
      new flash.display.Shape(),
      new flash.display.Sprite(),
    ];
    interfaces = [
      new flash.display.Bitmap(),
      new flash.display.BitmapData(100, 100),
      new flash.display.Sprite(),
      new flash.display.MovieClip(),
    ];
    a = 123;
  ...
  /*private*/ d.unknownParameters = function (
    param1 /*int*/,
    param2 /*String*/ /*void*/,
  ) {
  ...
  /*public*/ s.set_instance = function (
    value /*com.guepard.tests.Unknown*/ /*void*/,
  ) {

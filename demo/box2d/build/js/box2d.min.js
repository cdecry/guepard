(function () {
  ...
  d.TestCompound = function () {
    ...
    x;
    {
      ...
      for (i = 0; i < 5; ++i) {
        ...
        bd.position.Set(
          (x + 150.0) / this.m_physScale,
          (31.5 + 75.0 * -i + 300.0) / this.m_physScale,
        );
    ...
    }
    {
      ...
      pd2.SetAsOrientedBox(
        7.5 / this.m_physScale,
        15.0 / this.m_physScale,
        new Box2D.Common.Math.b2Vec2(0.0, -15.0 / this.m_physScale),
        0.5 * Math.PI,
      );
      bd = new Box2D.Dynamics.b2BodyDef();
      bd.type = Box2D.Dynamics.b2Body.b2_dynamicBody;
      for (i = 0; i < 5; ++i) {
        ...
        bd.position.Set(
          (x - 150.0) / this.m_physScale,
          (31.5 + 75.0 * -i + 300) / this.m_physScale,
        );
        bd.angle = Box2D.Common.Math.b2Math.RandomRange(-Math.PI, Math.PI);
        body = this.m_world.CreateBody(bd);
    ...
    }
    {
      ...
      xf1.position = Box2D.Common.Math.b2Math.MulMV(
        xf1.R,
        new Box2D.Common.Math.b2Vec2(1.0, 0.0),
      );
      sd1 = new Box2D.Collision.Shapes.b2PolygonShape();
      sd1.SetAsArray([
        Box2D.Common.Math.b2Math.MulX(
          xf1,
          new Box2D.Common.Math.b2Vec2(-30.0 / this.m_physScale, 0.0),
        ),
        Box2D.Common.Math.b2Math.MulX(
          xf1,
          new Box2D.Common.Math.b2Vec2(30.0 / this.m_physScale, 0.0),
      ...
      xf2.position = Box2D.Common.Math.b2Math.MulMV(
        xf2.R,
        new Box2D.Common.Math.b2Vec2(-30.0 / this.m_physScale, 0.0),
      );
      ...
      for (i = 0; i < 5; ++i) {
        ...
        bd.position.Set(
          x / this.m_physScale,
          (-61.5 + 55.0 * -i + 300) / this.m_physScale,
        );
        bd.angle = 0.0;
        body = this.m_world.CreateBody(bd);
    ...
    }
    {
      ...
      sd_left.SetAsOrientedBox(
        ...
        81.0 / this.m_physScale,
        new Box2D.Common.Math.b2Vec2(
          -43.5 / this.m_physScale,
          -70.5 / this.m_physScale,
        ),
        -0.2,
      );
  ...
  flash.addDescription("TestBed.TestCompound", d, "TestBed.Test", s, null, [
    "Main",
...
(function () {
  ...
  d.TestRagdoll = function () {
    ...
    for (i = 0; i < 2; i++) {
      ...
      bd.position.Set(
        startX / this.m_physScale,
        (startY + 28) / this.m_physScale,
      );
    ...
    for (j = 1; j <= 10; j++) {
      ...
      fixtureDef.shape = box;
      bd.position.Set(
        (10 * j) / this.m_physScale,
        (150 + 20 * j) / this.m_physScale,
      );
      head = this.m_world.CreateBody(bd);
      head.CreateFixture(fixtureDef);
    }
    for (k = 1; k <= 10; k++) {
      ...
      fixtureDef.shape = box;
      bd.position.Set(
        (640 - 10 * k) / this.m_physScale,
        (150 + 20 * k) / this.m_physScale,
      );
      head = this.m_world.CreateBody(bd);
      head.CreateFixture(fixtureDef);
    }
  ...
  flash.addDescription("TestBed.TestRagdoll", d, "TestBed.Test", s, null, [
    "Main",
    "Box2D.Dynamics.b2BodyDef",
...
(function () {
  ...
  d.TestCCD = function () {
    ...
    for (i = 0; i < 5; i++) {
      cd = new Box2D.Collision.Shapes.b2CircleShape(
        (Math.random() * 10 + 5) / this.m_physScale,
      );
      fixtureDef.shape = cd;
      ...
      bd.bullet = true;
      bd.position.Set(
        (Math.random() * 300 + 250) / this.m_physScale,
        (Math.random() * 320 + 20) / this.m_physScale,
      );
      body = this.m_world.CreateBody(bd);
      body.CreateFixture(fixtureDef);
    }
  ...
  flash.addDescription("TestBed.TestCCD", d, "TestBed.Test", s, null, [
    "Main",
    "Box2D.Dynamics.b2FixtureDef",
    "Box2D.Dynamics.b2BodyDef",
    "Box2D.Dynamics.b2Body",
...
(function () {
  ...
  d.TestBridge = function () {
    ...
    body;
    {
      ...
      anchor.Set(
        (100 + 44 * numPlanks) / this.m_physScale,
        250 / this.m_physScale,
      );
    ...
    for (i = 0; i < 5; i++) {
      ...
      fixtureDef.restitution = 0.1;
      boxShape.SetAsBox(
        (Math.random() * 5 + 10) / this.m_physScale,
        (Math.random() * 5 + 10) / this.m_physScale,
      );
      bodyDef.position.Set(
        (Math.random() * 400 + 120) / this.m_physScale,
        (Math.random() * 150 + 50) / this.m_physScale,
      );
    ...
    for (i = 0; i < 5; i++) {
      ...
      circShape = new Box2D.Collision.Shapes.b2CircleShape(
        (Math.random() * 5 + 10) / this.m_physScale,
      );
    ...
    for (i = 0; i < 15; i++) {
      ...
      if (Math.random() > 0.66) {
        ...
        vertices[0].Set(
          (-10 - Math.random() * 10) / this.m_physScale,
          (10 + Math.random() * 10) / this.m_physScale,
        );
        vertices[1].Set(
          (-5 - Math.random() * 10) / this.m_physScale,
          (-10 - Math.random() * 10) / this.m_physScale,
        );
        vertices[2].Set(
          (5 + Math.random() * 10) / this.m_physScale,
  ...
  flash.addDescription("TestBed.TestBridge", d, "TestBed.Test", s, null, [
    "Main",
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.Shapes.b2PolygonShape",
    "Box2D.Dynamics.b2FixtureDef",
...
(function () {
  ...
  d.Update = function () {
    ...
    var output = null;
    this.Test_Update();
    p1 = this.laser.GetWorldPoint(
      new Box2D.Common.Math.b2Vec2(30.1 / this.m_physScale, 0),
    );
    p2 = this.laser.GetWorldPoint(
      new Box2D.Common.Math.b2Vec2(130.1 / this.m_physScale, 0),
    );
    ...
    this.m_sprite
      .get_graphics()
      .moveTo(p1.x * this.m_physScale, p1.y * this.m_physScale);
    this.m_sprite
      .get_graphics()
      .lineTo(
        (p2.x * lambda + (1 - lambda) * p1.x) * this.m_physScale,
  ...
  flash.addDescription("TestBed.TestRaycast", d, "TestBed.Test", s, null, [
    "Main",
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.Shapes.b2PolygonShape",
    "Box2D.Dynamics.b2FixtureDef",
...
(function () {
  ...
  d.TestCrankGearsPulley = function () {
    ...
    fixtureDef = new Box2D.Dynamics.b2FixtureDef();
    {
      ...
      bd.type = Box2D.Dynamics.b2Body.b2_dynamicBody;
      bd.position.Set(
        100.0 / this.m_physScale,
        (360.0 - 105.0) / this.m_physScale,
      );
      body = this.m_world.CreateBody(bd);
      body.CreateFixture(fixtureDef);
      rjd.Initialize(
    ...
    anchor1 = new Box2D.Common.Math.b2Vec2(
      335 / this.m_physScale,
      180 / this.m_physScale,
    );
    anchor2 = new Box2D.Common.Math.b2Vec2(
      480 / this.m_physScale,
      180 / this.m_physScale,
    );
    groundAnchor1 = new Box2D.Common.Math.b2Vec2(
      335 / this.m_physScale,
      50 / this.m_physScale,
    );
    groundAnchor2 = new Box2D.Common.Math.b2Vec2(
      480 / this.m_physScale,
      50 / this.m_physScale,
    );
    ...
    body1.CreateFixture(fixtureDef);
    {
      ...
      ljd.Initialize(
        ...
        body,
        body.GetPosition(),
        new Box2D.Common.Math.b2Vec2(0.4, 0.6),
      );
    ...
    }
    {
      ...
      fjd.Initialize(
        circleBody,
        this.m_world.GetGroundBody(),
        circleBody.GetPosition(),
      );
...
(function () {
  ...
  d.TestBreakable = function () {
    ...
    ground = this.m_world.GetGroundBody();
    {
      ...
      this.m_shape1.SetAsOrientedBox(
        0.5,
        0.5,
        new Box2D.Common.Math.b2Vec2(-0.5, 0.0),
      );
      this.m_piece1 = this.m_body1.CreateFixture2(this.m_shape1, 1.0);
      this.m_shape2.SetAsOrientedBox(
        0.5,
        0.5,
        new Box2D.Common.Math.b2Vec2(0.5, 0.0),
      );
  ...
  d.Break = function () {
    ...
    this.m_body1.Split(
      flash.bindFunction(this, function (fixture) {
  ...
  flash.addDescription("TestBed.TestBreakable", d, "TestBed.Test", s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.Shapes.b2PolygonShape",
    "Main",
    "TestBed.ContactListener",
...
(function () {
  ...
  d.PostSolve = function (contact, impulse) {
    ...
    maxImpulse = 0.0;
    for (i = 0; i < count; i++) {
      maxImpulse = Box2D.Common.Math.b2Math.Max(
        maxImpulse,
...
(function () {
  ...
  d.TestTheoJansen = function () {
    ...
    for (i = 0; i < 40; ++i) {
      ...
      bd.type = Box2D.Dynamics.b2Body.b2_dynamicBody;
      bd.position.Set(
        (Math.random() * 620 + 10) / this.m_physScale,
        350 / this.m_physScale,
      );
      body = this.m_world.CreateBody(bd);
    ...
    this.CreateLeg(1.0, wheelAnchor);
    this.m_wheel.SetPositionAndAngle(
      this.m_wheel.GetPosition(),
      (120.0 * Math.PI) / 180.0,
    );
    this.CreateLeg(-1.0, wheelAnchor);
    this.CreateLeg(1.0, wheelAnchor);
  ...
  d.CreateLeg = function (s, wheelAnchor) {
    ...
    p3 = new Box2D.Common.Math.b2Vec2(
      (129 * s) / this.tScale,
      57 / this.tScale,
    );
    p4 = new Box2D.Common.Math.b2Vec2(
      (93 * s) / this.tScale,
      -24 / this.tScale,
    );
    p5 = new Box2D.Common.Math.b2Vec2(
      (180 * s) / this.tScale,
      -45 / this.tScale,
    );
    p6 = new Box2D.Common.Math.b2Vec2(
      (75 * s) / this.tScale,
      -111 / this.tScale,
    );
    sd1 = new Box2D.Collision.Shapes.b2PolygonShape();
    ...
    djd.Initialize(
      body1,
      body2,
      Box2D.Common.Math.b2Math.AddVV(p2, this.m_offset),
      Box2D.Common.Math.b2Math.AddVV(p5, this.m_offset),
    );
    this.m_world.CreateJoint(djd);
    djd.Initialize(
      body1,
      body2,
      Box2D.Common.Math.b2Math.AddVV(p3, this.m_offset),
      Box2D.Common.Math.b2Math.AddVV(p4, this.m_offset),
    );
    this.m_world.CreateJoint(djd);
    djd.Initialize(
      body1,
      this.m_wheel,
      Box2D.Common.Math.b2Math.AddVV(p3, this.m_offset),
      Box2D.Common.Math.b2Math.AddVV(wheelAnchor, this.m_offset),
    );
    this.m_world.CreateJoint(djd);
    djd.Initialize(
      body2,
      this.m_wheel,
      Box2D.Common.Math.b2Math.AddVV(p6, this.m_offset),
      Box2D.Common.Math.b2Math.AddVV(wheelAnchor, this.m_offset),
    );
    this.m_world.CreateJoint(djd);
    rjd = new Box2D.Dynamics.Joints.b2RevoluteJointDef();
  ...
  flash.addDescription("TestBed.TestTheoJansen", d, "TestBed.Test", s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Main",
    "Box2D.Collision.Shapes.b2CircleShape",
    "Box2D.Dynamics.b2BodyDef",
...
(function () {
  ...
  d.Test = function () {
    ...
    wallBd.position.Set(
      (640 + 95) / this.m_physScale,
      360 / this.m_physScale / 2,
    );
    wallB = this.m_world.CreateBody(wallBd);
    wallB.CreateFixture2(wall);
    ...
    wallB.CreateFixture2(wall);
    wallBd.position.Set(
      640 / this.m_physScale / 2,
      (360 + 95) / this.m_physScale,
    );
    wallB = this.m_world.CreateBody(wallBd);
    wallB.CreateFixture2(wall);
  };
  d.Update = function () {
    ...
    this.m_world.Step(
      this.m_timeStep,
      this.m_velocityIterations,
      this.m_positionIterations,
    );
  ...
  d.MouseDrag = function () {
    ...
    if (General.Input.mouseDown && !this.m_mouseJoint) {
      ...
      if (body) {
        ...
        md.bodyB = body;
        md.target.Set(
          TestBed.Test.mouseXWorldPhys,
          TestBed.Test.mouseYWorldPhys,
        );
  ...
  d.GetBodyAtMouse = function (includeStatic) {
    ...
    aabb.lowerBound.Set(
      TestBed.Test.mouseXWorldPhys - 0.001,
      TestBed.Test.mouseYWorldPhys - 0.001,
    );
    aabb.upperBound.Set(
      TestBed.Test.mouseXWorldPhys + 0.001,
      TestBed.Test.mouseYWorldPhys + 0.001,
    ...
    var GetBodyCallback = flash.bindFunction(this, function (fixture) {
      ...
      if (
        fixture.GetBody().GetType() != Box2D.Dynamics.b2Body.b2_staticBody ||
        includeStatic
      ) {
        inside = shape.TestPoint(
  ...
  flash.addDescription("TestBed.Test", d, null, s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Main",
...
(function () {
  ...
  d.TestStack = function () {
    ...
    for (i = 0; i < 10; i++) {
      ...
      bd.position.Set(
        (640 / 2 + 100) / this.m_physScale,
        (360 - 5 - i * 25) / this.m_physScale,
      );
    ...
    for (i = 0; i < 10; i++) {
      sd.SetAsBox(10 / this.m_physScale, 10 / this.m_physScale);
      bd.position.Set(
        (640 / 2 - 0 + Math.random() * 0.02 - 0.01) / this.m_physScale,
        (360 - 5 - i * 25) / this.m_physScale,
      );
      b = this.m_world.CreateBody(bd);
      b.CreateFixture(fd);
    ...
    for (i = 0; i < 10; i++) {
      sd.SetAsBox(10 / this.m_physScale, 10 / this.m_physScale);
      bd.position.Set(
        (640 / 2 + 200 + Math.random() * 0.02 - 0.01) / this.m_physScale,
        (360 - 5 - i * 25) / this.m_physScale,
      );
      b = this.m_world.CreateBody(bd);
      b.CreateFixture(fd);
  ...
  flash.addDescription("TestBed.TestStack", d, "TestBed.Test", s, null, [
    "Main",
    "Box2D.Dynamics.b2FixtureDef",
    "Box2D.Collision.Shapes.b2PolygonShape",
    "Box2D.Dynamics.b2BodyDef",
...
(function () {
  ...
  d.TestBuoyancy = function () {
    ...
    for (i = 0; i < 5; i++) {
      bodyDefC = new Box2D.Dynamics.b2BodyDef();
      bodyDefC.type = Box2D.Dynamics.b2Body.b2_dynamicBody;
      circDef = new Box2D.Collision.Shapes.b2CircleShape(
        (Math.random() * 5 + 10) / this.m_physScale,
      );
      fd = new Box2D.Dynamics.b2FixtureDef();
      fd.shape = circDef;
    ...
    for (i = 0; i < 15; i++) {
      ...
      if (Math.random() > 0.66) {
        ...
        array = [];
        array[0] = new Box2D.Common.Math.b2Vec2(
          0,
          (10 + Math.random() * 10) / this.m_physScale,
        );
        array[2] = new Box2D.Common.Math.b2Vec2(
          (-5 - Math.random() * 10) / this.m_physScale,
          (-10 - Math.random() * 10) / this.m_physScale,
        );
        array[3] = new Box2D.Common.Math.b2Vec2(
          (5 + Math.random() * 10) / this.m_physScale,
          (-10 - Math.random() * 10) / this.m_physScale,
        );
        array[1] = new Box2D.Common.Math.b2Vec2(
          array[0].x + array[2].x,
          array[0].y + array[2].y,
        );
        array[1].Multiply(Math.random() / 2 + 0.8);
        array[4] = new Box2D.Common.Math.b2Vec2(
          array[3].x + array[0].x,
          array[3].y + array[0].y,
        );
  ...
  flash.addDescription("TestBed.TestBuoyancy", d, "TestBed.Test", s, null, [
...
(function () {
  ...
  d.Input = function (stageMc) {
    ...
    stageMc
      ...
      .addEventListener(
        ...
        flash.bindFunction(this, this.keyPress),
        false,
        0,
        true,
      );
    stageMc
      ...
      .addEventListener(
        ...
        flash.bindFunction(this, this.keyRelease),
        false,
        0,
        true,
      );
    stageMc
      ...
      .addEventListener(
        ...
        flash.bindFunction(this, this.mousePress),
        false,
        0,
        true,
      );
    stageMc
      ...
      .addEventListener(
        ...
        flash.bindFunction(this, this.mouseRelease),
        false,
        0,
        true,
      );
    stageMc
      ...
      .addEventListener(
        ...
        flash.bindFunction(this, this.mouseMove),
        false,
        0,
        true,
      );
    stageMc
      ...
      .addEventListener(
        ...
        flash.bindFunction(this, this.mouseLeave),
        false,
        0,
        true,
      );
  ...
  d.mouseMove = function (e) {
    ...
    General.Input.mouseOffsetX =
      General.Input.mouseX - General.Input.mouse.get_x();
    General.Input.mouseOffsetY =
      General.Input.mouseY - General.Input.mouse.get_y();
    if (General.Input.mouseDown) {
  ...
  d.keyPress = function (e) {
    General.Input.keyState[e.get_keyCode()] = Math.max(
      General.Input.keyState[e.get_keyCode()],
      1,
    );
  ...
  s.isKeyInBuffer = function (k, i, t) {
    ...
    t = flash.int(t);
    return (
      General.Input.keyBuffer[i][0] == k && General.Input.keyBuffer[i][1] <= t
    );
  };
  ...
  flash.addDescription("General.Input", d, null, s, null, [
...
(function () {
  ...
  s.limitFrame = function (maxFPS) {
    ...
    while (
      Math.abs(General.FRateLimiter.newT - General.FRateLimiter.oldT) < fTime
    ) {
...
(function () {
  ...
  d.update = function () {
    ...
    if (this.avgCount < 1) {
      this.textBox.set_text(
        String(Math.round(1000 / (this.mfpsCount / 30)) + " fps average"),
      );
      this.avgCount = 30;
      this.mfpsCount = 0;
    }
    ...
    this.oldT = flash.utils.getTimer();
    this.textBox3.set_text(
      Math.round(flash.system.System.get_totalMemory() / (1024 * 1024)) +
        " MB used",
    );
  };
  ...
  flash.addDescription(
    ...
    s,
    null,
    ["flash.text.TextField", "flash.system.System"],
  );
})();
(function () {
  "use strict";
  ...
  d.Main = function () {
    ...
    this.addEventListener(
      ...
      flash.bindFunction(this, this.update),
      false,
      0,
      true,
    );
    ...
    instructions_text_format = new flash.text.TextFormat(
      "Arial",
      16,
      0xffffff,
      false,
    ...
    m_aboutTextFormat = new flash.text.TextFormat(
      "Arial",
      16,
      0x00ccff,
      true,
  ...
  flash.addDescription("Main", d, "flash.display.MovieClip", s, null, [
    "General.FpsCounter",
    "flash.events.Event",
    "flash.display.Sprite",
    "General.Input",
...
(function () {
  ...
  d.QueryPoint = function (callback, p) {
    ...
    aabb = new Box2D.Collision.b2AABB();
    aabb.lowerBound.Set(
      p.x - Box2D.Common.b2Settings.b2_linearSlop,
      p.y - Box2D.Common.b2Settings.b2_linearSlop,
    );
    aabb.upperBound.Set(
      p.x + Box2D.Common.b2Settings.b2_linearSlop,
      p.y + Box2D.Common.b2Settings.b2_linearSlop,
  ...
  d.RayCast = function (callback, point1, point2) {
    ...
    var RayCastWrapper = flash.bindFunction(this, function (input, proxy) {
      ...
      if (hit) {
        ...
        point = new Box2D.Common.Math.b2Vec2(
  ...
  d.RayCastOne = function (point1, point2) {
    var result = null;
    result;
    var RayCastOneWrapper = flash.bindFunction(
      this,
  ...
  d.RayCastAll = function (point1, point2) {
    ...
    result = new Array();
    RayCastAllWrapper = flash.bindFunction(
      this,
      function (fixture, point, normal, fraction) {
  ...
  d.SolveTOI = function (step) {
    ...
    for (c = this.m_contactList; c; c = c.m_next) {
      c.m_flags &= ~(
        ...
        Box2D.Dynamics.Contacts.b2Contact.e_islandFlag
      );
    }
    for (j = this.m_jointList; j; j = j.m_next) {
      j.m_islandFlag = false;
    ...
    while (true) {
      ...
      for (c = this.m_contactList; c; c = c.m_next) {
        ...
        if (c.m_flags & Box2D.Dynamics.Contacts.b2Contact.e_toiFlag) {
          ...
          bB = fB.m_body;
          if (
            (bA.GetType() != Box2D.Dynamics.b2Body.b2_dynamicBody ||
              bA.IsAwake() == false) &&
            (bB.GetType() != Box2D.Dynamics.b2Body.b2_dynamicBody ||
              bB.IsAwake() == false)
          ) {
            continue;
          }
      ...
      case Box2D.Collision.Shapes.b2Shape.e_edgeShape:
        {
          ...
          this.m_debugDraw.DrawSegment(
            Box2D.Common.Math.b2Math.MulX(xf, edge.GetVertex1()),
            Box2D.Common.Math.b2Math.MulX(xf, edge.GetVertex2()),
            color,
          );
        }
        break;
  ...
  flash.addDescription("Box2D.Dynamics.b2World", d, null, s, null, [
...
(function () {
  ...
  flash.addDescription("Box2D.Dynamics.b2FixtureDef", d, null, null, null, [
...
(function () {
  ...
  d.Synchronize = function (broadPhase, transform1, transform2) {
    ...
    displacement = Box2D.Common.Math.b2Math.SubtractVV(
      transform2.position,
      transform1.position,
    );
    broadPhase.MoveProxy(this.m_proxy, this.m_aabb, displacement);
  };
  flash.addDescription("Box2D.Dynamics.b2Fixture", d, null, null, null, [
    "Box2D.Dynamics.b2FilterData",
    "Box2D.Collision.b2AABB",
...
(function () {
  ...
  d.Reset = function (fixtureA, fixtureB) {
    ...
    Box2D.Common.b2Settings.b2Assert(
      fixtureA.GetType() == Box2D.Collision.Shapes.b2Shape.e_polygonShape,
    );
    Box2D.Common.b2Settings.b2Assert(
      fixtureB.GetType() == Box2D.Collision.Shapes.b2Shape.e_circleShape,
    );
  };
  d.Evaluate = function () {
    var bA = null;
  ...
  d.Initialize = function (step, contacts, contactCount, allocator) {
    ...
    while (this.m_constraints.length < this.m_constraintCount) {
      this.m_constraints[this.m_constraints.length] =
        new Box2D.Dynamics.Contacts.b2ContactConstraint();
    }
    for (i = 0; i < contactCount; ++i) {
      ...
      friction = Box2D.Common.b2Settings.b2MixFriction(
        fixtureA.GetFriction(),
        fixtureB.GetFriction(),
      );
      restitution = Box2D.Common.b2Settings.b2MixRestitution(
      ...
      Box2D.Dynamics.Contacts.b2ContactSolver.s_worldManifold.Initialize(
        manifold,
        bodyA.m_xf,
        radiusA,
        bodyB.m_xf,
      ...
      normalX =
        Box2D.Dynamics.Contacts.b2ContactSolver.s_worldManifold.m_normal.x;
      normalY =
        Box2D.Dynamics.Contacts.b2ContactSolver.s_worldManifold.m_normal.y;
      ...
      for (k = 0; k < cc.pointCount; ++k) {
        ...
        rAX = ccp.rA.x =
          Box2D.Dynamics.Contacts.b2ContactSolver.s_worldManifold.m_points[k]
            .x - bodyA.m_sweep.c.x;
        rAY = ccp.rA.y =
          Box2D.Dynamics.Contacts.b2ContactSolver.s_worldManifold.m_points[k]
            .y - bodyA.m_sweep.c.y;
  ...
  d.SolveVelocityConstraints = function () {
    ...
    for (i = 0; i < this.m_constraintCount; ++i) {
      ...
      for (j = 0; j < c.pointCount; j++) {
        ...
        newImpulse = Box2D.Common.Math.b2Math.Clamp(
  ...
  d.SolvePositionConstraints = function (baumgarte) {
    ...
    for (i = 0; i < this.m_constraintCount; i++) {
      ...
      for (j = 0; j < c.pointCount; j++) {
        ...
        separation =
          Box2D.Dynamics.Contacts.b2ContactSolver.s_psm.m_separations[j];
        ...
        C = Box2D.Common.Math.b2Math.Clamp(
          baumgarte * (separation + Box2D.Common.b2Settings.b2_linearSlop),
...
(function () {
  ...
  d.Reset = function (fixtureA, fixtureB) {
    ...
    Box2D.Common.b2Settings.b2Assert(
      fixtureB.GetType() == Box2D.Collision.Shapes.b2Shape.e_edgeShape,
    );
  };
  d.Evaluate = function () {
    var bA = null;
...
(function () {
  ...
  d.Evaluate = function () {
    ...
    bA = this.m_fixtureA.GetBody();
    bB = this.m_fixtureB.GetBody();
    Box2D.Collision.b2Collision.CollideCircles(
      this.m_manifold,
      this.m_fixtureA.GetShape(),
      bA.m_xf,
      this.m_fixtureB.GetShape(),
...
(function () {
  ...
  d.IsContinuous = function () {
    return (
      ...
      Box2D.Dynamics.Contacts.b2Contact.e_continuousFlag
    );
  };
  d.SetSensor = function (sensor) {
    if (sensor) {
  ...
  d.IsSensor = function () {
    return (
      (this.m_flags & Box2D.Dynamics.Contacts.b2Contact.e_sensorFlag) ==
      Box2D.Dynamics.Contacts.b2Contact.e_sensorFlag
    );
  };
  ...
  d.Reset = function (fixtureA, fixtureB) {
    ...
    if (
      bodyA.GetType() != Box2D.Dynamics.b2Body.b2_dynamicBody ||
      bodyA.IsBullet() ||
      bodyB.GetType() != Box2D.Dynamics.b2Body.b2_dynamicBody ||
      bodyB.IsBullet()
    ) {
      this.m_flags |= Box2D.Dynamics.Contacts.b2Contact.e_continuousFlag;
    }
  ...
  d.Update = function (listener) {
    ...
    if (this.m_flags & Box2D.Dynamics.Contacts.b2Contact.e_sensorFlag) {
      if (aabbOverlap) {
        ...
        touching = Box2D.Collision.Shapes.b2Shape.TestOverlap(
          shapeA,
          xfA,
          shapeB,
          xfB,
  ...
  d.ComputeTOI = function (sweepA, sweepB) {
    Box2D.Dynamics.Contacts.b2Contact.s_input.proxyA.Set(
      this.m_fixtureA.GetShape(),
    );
    Box2D.Dynamics.Contacts.b2Contact.s_input.proxyB.Set(
      this.m_fixtureB.GetShape(),
    );
    Box2D.Dynamics.Contacts.b2Contact.s_input.sweepA = sweepA;
    Box2D.Dynamics.Contacts.b2Contact.s_input.sweepB = sweepB;
    Box2D.Dynamics.Contacts.b2Contact.s_input.tolerance =
      Box2D.Common.b2Settings.b2_linearSlop;
    return Box2D.Collision.b2TimeOfImpact.TimeOfImpact(
  ...
  flash.addDescription("Box2D.Dynamics.Contacts.b2Contact", d, null, s, null, [
...
(function () {
  ...
  d.Evaluate = function () {
    ...
    bA = this.m_fixtureA.GetBody();
    bB = this.m_fixtureB.GetBody();
    Box2D.Collision.b2Collision.CollidePolygons(
      this.m_manifold,
      this.m_fixtureA.GetShape(),
      bA.m_xf,
      this.m_fixtureB.GetShape(),
  ...
  d.InitializeRegisters = function () {
    ...
    for (i = 0; i < Box2D.Collision.Shapes.b2Shape.e_shapeTypeCount; i++) {
      ...
      for (j = 0; j < Box2D.Collision.Shapes.b2Shape.e_shapeTypeCount; j++) {
        this.m_registers[i][j] =
          new Box2D.Dynamics.Contacts.b2ContactRegister();
      }
    }
    this.AddType(
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2CircleContact,
        Box2D.Dynamics.Contacts.b2CircleContact.Create,
      ),
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2CircleContact,
        Box2D.Dynamics.Contacts.b2CircleContact.Destroy,
      ),
    ...
    this.AddType(
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2PolyAndCircleContact,
        Box2D.Dynamics.Contacts.b2PolyAndCircleContact.Create,
      ),
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2PolyAndCircleContact,
        Box2D.Dynamics.Contacts.b2PolyAndCircleContact.Destroy,
      ),
    ...
    this.AddType(
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2PolygonContact,
        Box2D.Dynamics.Contacts.b2PolygonContact.Create,
      ),
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2PolygonContact,
        Box2D.Dynamics.Contacts.b2PolygonContact.Destroy,
      ),
      Box2D.Collision.Shapes.b2Shape.e_polygonShape,
      Box2D.Collision.Shapes.b2Shape.e_polygonShape,
    );
    this.AddType(
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2EdgeAndCircleContact,
        Box2D.Dynamics.Contacts.b2EdgeAndCircleContact.Create,
      ),
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2EdgeAndCircleContact,
        Box2D.Dynamics.Contacts.b2EdgeAndCircleContact.Destroy,
      ),
    ...
    this.AddType(
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2PolyAndEdgeContact,
        Box2D.Dynamics.Contacts.b2PolyAndEdgeContact.Create,
      ),
      flash.bindFunction(
        Box2D.Dynamics.Contacts.b2PolyAndEdgeContact,
        Box2D.Dynamics.Contacts.b2PolyAndEdgeContact.Destroy,
      ),
      Box2D.Collision.Shapes.b2Shape.e_polygonShape,
      Box2D.Collision.Shapes.b2Shape.e_edgeShape,
    );
...
(function () {
  ...
  d.Initialize = function (bA, bB, gaA, gaB, anchorA, anchorB, r) {
    ...
    this.maxLengthA =
      C - this.ratio * Box2D.Dynamics.Joints.b2PulleyJoint.b2_minPulleyLength;
    this.maxLengthB =
      (C - Box2D.Dynamics.Joints.b2PulleyJoint.b2_minPulleyLength) / this.ratio;
  };
  var s = {};
  s.__init__ = function () {
...
(function () {
  ...
  flash.addDescription(
    ...
    s,
    null,
    ["Box2D.Common.Math.b2Vec2", "Box2D.Dynamics.Joints.b2Joint"],
  );
})();
(function () {
  "use strict";
...
(function () {
  ...
  d.SolvePositionConstraints = function (baumgarte) {
    ...
    bB.SynchronizeTransform();
    return (
      positionError <= Box2D.Common.b2Settings.b2_linearSlop &&
      angularError <= Box2D.Common.b2Settings.b2_angularSlop
    );
  };
  var s = {};
  s.__init__ = function () {
...
(function () {
  ...
  d.InitVelocityConstraints = function (step) {
    ...
    {
      this.m_axis.SetV(
        Box2D.Common.Math.b2Math.MulMV(xf1.R, this.m_localXAxis1),
      );
    ...
    {
      this.m_perp.SetV(
        Box2D.Common.Math.b2Math.MulMV(xf1.R, this.m_localYAxis1),
      );
    ...
    if (this.m_enableLimit) {
      ...
      if (
        Box2D.Common.Math.b2Math.Abs(
          this.m_upperTranslation - this.m_lowerTranslation,
        ) <
        2.0 * Box2D.Common.b2Settings.b2_linearSlop
      ) {
  ...
  d.SolveVelocityConstraints = function (step) {
    ...
    if (
      ...
      this.m_motorImpulse = Box2D.Common.Math.b2Math.Clamp(
  ...
  d.SolvePositionConstraints = function (baumgarte) {
    ...
    if (this.m_enableLimit) {
      ...
      if (
        ...
        C2 = Box2D.Common.Math.b2Math.Clamp(
          translation,
          -Box2D.Common.b2Settings.b2_maxLinearCorrection,
          Box2D.Common.b2Settings.b2_maxLinearCorrection,
        );
    ...
    linearError = Box2D.Common.Math.b2Math.Max(
      linearError,
      Box2D.Common.Math.b2Math.Abs(C1X),
    );
    ...
    bB.SynchronizeTransform();
    return (
      linearError <= Box2D.Common.b2Settings.b2_linearSlop &&
      angularError <= Box2D.Common.b2Settings.b2_angularSlop
    );
  };
...
(function () {
  ...
  d.SolvePositionConstraints = function (baumgarte) {
    ...
    bB.SynchronizeTransform();
    return (
      Box2D.Common.Math.b2Math.Abs(C) < Box2D.Common.b2Settings.b2_linearSlop
    );
  };
...
(function () {
  ...
  d.InitVelocityConstraints = function (step) {
    ...
    if (this.m_enableLimit) {
      ...
      if (
        Box2D.Common.Math.b2Math.Abs(this.m_upperAngle - this.m_lowerAngle) <
        2.0 * Box2D.Common.b2Settings.b2_angularSlop
      ) {
        this.m_limitState = Box2D.Dynamics.Joints.b2Joint.e_equalLimits;
  ...
  d.SolvePositionConstraints = function (baumgarte) {
    ...
    if (
      ...
      if (this.m_limitState == Box2D.Dynamics.Joints.b2Joint.e_equalLimits) {
        ...
        angularError = -C;
        C = Box2D.Common.Math.b2Math.Clamp(
          C + Box2D.Common.b2Settings.b2_angularSlop,
          -Box2D.Common.b2Settings.b2_maxAngularCorrection,
          0.0,
        );
        limitImpulse = -this.m_motorMass * C;
...
(function () {
  ...
  d.SolveVelocityConstraints = function (step) {
    ...
    maxImpulse;
    {
      ...
      this.m_angularImpulse = Box2D.Common.Math.b2Math.Clamp(
    ...
    }
    {
      ...
      impulseV = Box2D.Common.Math.b2Math.MulMV(
        this.m_linearMass,
        new Box2D.Common.Math.b2Vec2(-CdotX, -CdotY),
      );
      ...
      impulseV = Box2D.Common.Math.b2Math.SubtractVV(
...
(function () {
  ...
  flash.addDescription("Box2D.Dynamics.Joints.b2Joint", d, null, s, null, [
    "Box2D.Dynamics.Joints.b2JointEdge",
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Dynamics.Joints.b2DistanceJoint",
    "Box2D.Dynamics.Joints.b2DistanceJointDef",
...
(function () {
  ...
  d.SolvePositionConstraints = function (baumgarte) {
    ...
    linearError = Box2D.Common.Math.b2Math.Max(
      linearError,
      Box2D.Common.Math.b2Math.Abs(C1),
    );
    angularError = 0.0;
    if (active) {
      m1 = this.m_invMassA;
...
(function () {
  ...
  flash.addDescription(
    ...
    s,
    null,
    ["Box2D.Common.Math.b2Mat22", "Box2D.Common.Math.b2Vec2"],
  );
})();
(function () {
  "use strict";
...
(function () {
  ...
  d.b2PulleyJoint = function (def) {
    ...
    this.m_maxLength1 = Box2D.Common.Math.b2Math.Min(
      def.maxLengthA,
      this.m_constant -
        this.m_ratio * Box2D.Dynamics.Joints.b2PulleyJoint.b2_minPulleyLength,
    );
    this.m_maxLength2 = Box2D.Common.Math.b2Math.Min(
      def.maxLengthB,
      (this.m_constant -
  ...
  d.SolveVelocityConstraints = function (step) {
    ...
    if (this.m_state == Box2D.Dynamics.Joints.b2Joint.e_atUpperLimit) {
      ...
      this.m_impulse = Box2D.Common.Math.b2Math.Max(
        0.0,
        this.m_impulse + impulse,
      );
    ...
    if (this.m_limitState1 == Box2D.Dynamics.Joints.b2Joint.e_atUpperLimit) {
      ...
      this.m_limitImpulse1 = Box2D.Common.Math.b2Math.Max(
        0.0,
    ...
    if (this.m_limitState2 == Box2D.Dynamics.Joints.b2Joint.e_atUpperLimit) {
      ...
      this.m_limitImpulse2 = Box2D.Common.Math.b2Math.Max(
        0.0,
  ...
  d.SolvePositionConstraints = function (baumgarte) {
    ...
    if (this.m_state == Box2D.Dynamics.Joints.b2Joint.e_atUpperLimit) {
      ...
      C = Box2D.Common.Math.b2Math.Clamp(
        C + Box2D.Common.b2Settings.b2_linearSlop,
        -Box2D.Common.b2Settings.b2_maxLinearCorrection,
        0.0,
      );
...
(function () {
  ...
  flash.addDescription("Box2D.Dynamics.b2ContactManager", d, null, s, null, [
...
(function () {
  ...
  d.GetDefinition = function () {
    ...
    bd.fixedRotation =
      (this.m_flags & Box2D.Dynamics.b2Body.e_fixedRotationFlag) ==
      Box2D.Dynamics.b2Body.e_fixedRotationFlag;
    bd.bullet =
      (this.m_flags & Box2D.Dynamics.b2Body.e_bulletFlag) ==
      Box2D.Dynamics.b2Body.e_bulletFlag;
    bd.awake =
      (this.m_flags & Box2D.Dynamics.b2Body.e_awakeFlag) ==
      Box2D.Dynamics.b2Body.e_awakeFlag;
  ...
  d.Split = function (callback) {
    ...
    velocity1 = Box2D.Common.Math.b2Math.AddVV(
      linearVelocity,
      Box2D.Common.Math.b2Math.CrossFV(
        angularVelocity,
        Box2D.Common.Math.b2Math.SubtractVV(center1, center),
      ),
    );
    velocity2 = Box2D.Common.Math.b2Math.AddVV(
      linearVelocity,
      Box2D.Common.Math.b2Math.CrossFV(
        angularVelocity,
  ...
  d.SetMassData = function (massData) {
    ...
    this.m_sweep.c0.SetV(
      Box2D.Common.Math.b2Math.MulX(this.m_xf, this.m_sweep.localCenter),
    );
  ...
  d.ResetMassData = function () {
    ...
    this.m_sweep.localCenter.SetZero();
    if (
      this.m_type == Box2D.Dynamics.b2Body.b2_staticBody ||
      this.m_type == Box2D.Dynamics.b2Body.b2_kinematicBody
    ) {
      return;
    }
  ...
  d.GetWorldPoint = function (localPoint) {
    ...
    var u = null;
    A = this.m_xf.R;
    u = new Box2D.Common.Math.b2Vec2(
  ...
  d.GetLinearVelocityFromLocalPoint = function (localPoint) {
    ...
    var worldPoint = null;
    A = this.m_xf.R;
    worldPoint = new Box2D.Common.Math.b2Vec2(
      A.col1.x * localPoint.x + A.col2.x * localPoint.y,
      A.col1.y * localPoint.x + A.col2.y * localPoint.y,
    );
  ...
  d.IsActive = function () {
    return (
      (this.m_flags & Box2D.Dynamics.b2Body.e_activeFlag) ==
      Box2D.Dynamics.b2Body.e_activeFlag
    );
  };
  ...
  d.ShouldCollide = function (other) {
    var jn = null;
    if (
      this.m_type != Box2D.Dynamics.b2Body.b2_dynamicBody &&
      other.m_type != Box2D.Dynamics.b2Body.b2_dynamicBody
    ) {
      return false;
    }
  ...
  flash.addDescription("Box2D.Dynamics.b2Body", d, null, s, null, [
    "Box2D.Common.Math.b2Transform",
    "Box2D.Common.Math.b2Sweep",
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Dynamics.b2Fixture",
...
(function () {
  ...
  flash.addDescription("Box2D.Dynamics.b2BodyDef", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Dynamics.b2Body",
  ]);
})();
(function () {
  ...
  d.DrawPolygon = function (vertices, vertexCount, color) {
    ...
    this.m_sprite
      .get_graphics()
      .lineStyle(this.m_lineThickness, color.get_color(), this.m_alpha);
    this.m_sprite
      .get_graphics()
      .moveTo(
        vertices[0].x * this.m_drawScale,
        vertices[0].y * this.m_drawScale,
      );
    for (i = 1; i < vertexCount; i++) {
      this.m_sprite
        .get_graphics()
        .lineTo(
          vertices[i].x * this.m_drawScale,
          vertices[i].y * this.m_drawScale,
        );
    }
    this.m_sprite
      .get_graphics()
  ...
  d.DrawCircle = function (center, radius, color) {
    ...
    this.m_sprite
      .get_graphics()
      .drawCircle(
        center.x * this.m_drawScale,
        center.y * this.m_drawScale,
  ...
  d.DrawSolidCircle = function (center, radius, axis, color) {
    ...
    this.m_sprite
      .get_graphics()
      .moveTo(center.x * this.m_drawScale, center.y * this.m_drawScale);
    this.m_sprite
      .get_graphics()
      .lineTo(
        (center.x + axis.x * radius) * this.m_drawScale,
        (center.y + axis.y * radius) * this.m_drawScale,
      );
  };
  d.DrawSegment = function (p1, p2, color) {
    ...
    this.m_sprite
      .get_graphics()
      .moveTo(p1.x * this.m_drawScale, p1.y * this.m_drawScale);
    this.m_sprite
      .get_graphics()
      .lineTo(p2.x * this.m_drawScale, p2.y * this.m_drawScale);
  };
  d.DrawTransform = function (xf) {
    this.m_sprite
      .get_graphics()
      .lineStyle(this.m_lineThickness, 0xff0000, this.m_alpha);
    this.m_sprite
      .get_graphics()
      .moveTo(
        xf.position.x * this.m_drawScale,
        xf.position.y * this.m_drawScale,
      );
    this.m_sprite
      .get_graphics()
      .lineTo(
        (xf.position.x + this.m_xformScale * xf.R.col1.x) * this.m_drawScale,
        (xf.position.y + this.m_xformScale * xf.R.col1.y) * this.m_drawScale,
      );
    this.m_sprite
      .get_graphics()
      .lineStyle(this.m_lineThickness, 0x00ff00, this.m_alpha);
    this.m_sprite
      .get_graphics()
      .moveTo(
        xf.position.x * this.m_drawScale,
    ...
    this.m_sprite
      .get_graphics()
      .lineTo(
        (xf.position.x + this.m_xformScale * xf.R.col2.x) * this.m_drawScale,
...
(function () {
  ...
  flash.addDescription("Box2D.Dynamics.b2ContactListener", d, null, s, null, [
    "Box2D.Dynamics.b2ContactListener",
  ]);
})();
(function () {
  ...
  d.Solve = function (step, gravity, allowSleep) {
    ...
    for (i = 0; i < this.m_bodyCount; ++i) {
      ...
      b.m_linearVelocity.Multiply(
        Box2D.Common.Math.b2Math.Clamp(
          1.0 - step.dt * b.m_linearDamping,
          0.0,
          1.0,
        ),
      );
      b.m_angularVelocity *= Box2D.Common.Math.b2Math.Clamp(
    ...
    for (i = 0; i < this.m_bodyCount; ++i) {
      ...
      if (
        ...
        b.m_linearVelocity.x *=
          Box2D.Common.b2Settings.b2_maxTranslation * step.inv_dt;
      ...
      if (rotation * rotation > Box2D.Common.b2Settings.b2_maxRotationSquared) {
        if (b.m_angularVelocity < 0.0) {
          b.m_angularVelocity =
            -Box2D.Common.b2Settings.b2_maxRotation * step.inv_dt;
        } else {
          b.m_angularVelocity =
            Box2D.Common.b2Settings.b2_maxRotation * step.inv_dt;
        }
    ...
    if (allowSleep) {
      ...
      for (i = 0; i < this.m_bodyCount; ++i) {
        ...
        if (
          (b.m_flags & Box2D.Dynamics.b2Body.e_allowSleepFlag) == 0 ||
          b.m_angularVelocity * b.m_angularVelocity > angTolSqr ||
          Box2D.Common.Math.b2Math.Dot(b.m_linearVelocity, b.m_linearVelocity) >
            linTolSqr
        ) {
          b.m_sleepTime = 0.0;
          minSleepTime = 0.0;
          ...
          minSleepTime = Box2D.Common.Math.b2Math.Min(
            minSleepTime,
            b.m_sleepTime,
          );
        }
  ...
  d.SolveTOI = function (subStep) {
    ...
    for (i = 0; i < this.m_bodyCount; ++i) {
      ...
      if (
        ...
        b.m_linearVelocity.Normalize();
        b.m_linearVelocity.x *=
          Box2D.Common.b2Settings.b2_maxTranslation * subStep.inv_dt;
        b.m_linearVelocity.y *=
          Box2D.Common.b2Settings.b2_maxTranslation * subStep.inv_dt;
      }
      ...
      if (rotation * rotation > Box2D.Common.b2Settings.b2_maxRotationSquared) {
        if (b.m_angularVelocity < 0.0) {
          b.m_angularVelocity =
            -Box2D.Common.b2Settings.b2_maxRotation * subStep.inv_dt;
        } else {
          b.m_angularVelocity =
            Box2D.Common.b2Settings.b2_maxRotation * subStep.inv_dt;
        }
    ...
    for (i = 0; i < subStep.positionIterations; ++i) {
      ...
      jointsOkay = true;
      for (j = 0; j < this.m_jointCount; ++j) {
        jointOkay = this.m_joints[j].SolvePositionConstraints(
          Box2D.Common.b2Settings.b2_contactBaumgarte,
        );
        jointsOkay = jointsOkay && jointOkay;
      }
  ...
  d.Report = function (constraints) {
    ...
    for (i = 0; i < this.m_contactCount; ++i) {
      ...
      for (j = 0; j < cc.pointCount; ++j) {
        Box2D.Dynamics.b2Island.s_impulse.normalImpulses[j] =
          cc.points[j].normalImpulse;
        Box2D.Dynamics.b2Island.s_impulse.tangentImpulses[j] =
  ...
  flash.addDescription("Box2D.Dynamics.b2Island", d, null, s, null, [
    "Box2D.Dynamics.b2ContactImpulse",
    "Box2D.Dynamics.b2Body",
    "Box2D.Dynamics.Contacts.b2Contact",
    "Box2D.Dynamics.Joints.b2Joint",
...
(function () {
  ...
  flash.addDescription("Box2D.Dynamics.b2FilterData", d, null, null, null, [
    "Box2D.Dynamics.b2FilterData",
  ]);
})();
(function () {
...
(function () {
  ...
  flash.addDescription(
    ...
    s,
    null,
    ["Box2D.Common.Math.b2Vec2", "Box2D.Common.b2Color"],
  );
})();
(function () {
  "use strict";
...
(function () {
  ...
  flash.addDescription("Box2D.Dynamics.b2ContactFilter", d, null, s, null, [
    "Box2D.Dynamics.b2ContactFilter",
    "Box2D.Dynamics.b2Fixture",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Common.b2Color", d, null, null, null, [
    "Box2D.Common.Math.b2Math",
  ]);
})();
(function () {
  ...
  s.__init__ = function () {
    ...
    this.b2_maxAngularCorrection =
      (8.0 / 180.0) * Box2D.Common.b2Settings.b2_pi;
    this.b2_maxTranslation = 2.0;
    this.b2_maxTranslationSquared =
      Box2D.Common.b2Settings.b2_maxTranslation *
      Box2D.Common.b2Settings.b2_maxTranslation;
    this.b2_maxRotation = 0.5 * Box2D.Common.b2Settings.b2_pi;
    this.b2_maxRotationSquared =
  ...
  flash.addDescription("Box2D.Common.b2Settings", d, null, s, null, [
    "Box2D.Common.b2Settings",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Common.Math.b2Mat22", d, null, s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Common.Math.b2Mat22",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Common.Math.b2Mat33", d, null, null, null, [
    "Box2D.Common.Math.b2Vec3",
    "Box2D.Common.Math.b2Mat33",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Common.Math.b2Vec3", d, null, null, null, [
    "Box2D.Common.Math.b2Vec3",
  ]);
})();
(function () {
  ...
  s.__init__ = function () {
    ...
    this.b2Mat22_identity = Box2D.Common.Math.b2Mat22.FromVV(
      new Box2D.Common.Math.b2Vec2(1.0, 0.0),
      new Box2D.Common.Math.b2Vec2(0.0, 1.0),
    );
    this.b2Transform_identity = new Box2D.Common.Math.b2Transform(
  ...
  s.MulTMV = function (A, v) {
    var u = null;
    u = new Box2D.Common.Math.b2Vec2(
      Box2D.Common.Math.b2Math.Dot(v, A.col1),
      Box2D.Common.Math.b2Math.Dot(v, A.col2),
    );
    return u;
  };
  s.MulX = function (T, v) {
  ...
  s.AddMM = function (A, B) {
    var C = null;
    C = Box2D.Common.Math.b2Mat22.FromVV(
      Box2D.Common.Math.b2Math.AddVV(A.col1, B.col1),
      Box2D.Common.Math.b2Math.AddVV(A.col2, B.col2),
    );
    return C;
  };
  s.MulMM = function (A, B) {
    var C = null;
    C = Box2D.Common.Math.b2Mat22.FromVV(
      Box2D.Common.Math.b2Math.MulMV(A, B.col1),
      Box2D.Common.Math.b2Math.MulMV(A, B.col2),
    );
    return C;
  };
  s.MulTMM = function (A, B) {
    ...
    var c2 = null;
    var C = null;
    c1 = new Box2D.Common.Math.b2Vec2(
      Box2D.Common.Math.b2Math.Dot(A.col1, B.col1),
      Box2D.Common.Math.b2Math.Dot(A.col2, B.col1),
    );
    c2 = new Box2D.Common.Math.b2Vec2(
      Box2D.Common.Math.b2Math.Dot(A.col1, B.col2),
      Box2D.Common.Math.b2Math.Dot(A.col2, B.col2),
    );
  ...
  s.AbsV = function (a) {
    ...
    b = new Box2D.Common.Math.b2Vec2(
      Box2D.Common.Math.b2Math.Abs(a.x),
      Box2D.Common.Math.b2Math.Abs(a.y),
    );
    return b;
  };
  s.AbsM = function (A) {
    var B = null;
    B = Box2D.Common.Math.b2Mat22.FromVV(
      Box2D.Common.Math.b2Math.AbsV(A.col1),
      Box2D.Common.Math.b2Math.AbsV(A.col2),
    );
    return B;
  };
  s.Min = function (a, b) {
  ...
  s.MinV = function (a, b) {
    ...
    c = new Box2D.Common.Math.b2Vec2(
      Box2D.Common.Math.b2Math.Min(a.x, b.x),
      Box2D.Common.Math.b2Math.Min(a.y, b.y),
    );
    return c;
  };
  s.Max = function (a, b) {
  ...
  s.MaxV = function (a, b) {
    var c = null;
    c = new Box2D.Common.Math.b2Vec2(
      Box2D.Common.Math.b2Math.Max(a.x, b.x),
      Box2D.Common.Math.b2Math.Max(a.y, b.y),
    );
    return c;
  };
  ...
  s.ClampV = function (a, low, high) {
    return Box2D.Common.Math.b2Math.MaxV(
      low,
      Box2D.Common.Math.b2Math.MinV(a, high),
    );
  };
  s.Swap = function (a, b) {
    var tmp = null;
  ...
  flash.addDescription("Box2D.Common.Math.b2Math", d, null, s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Common.Math.b2Mat22",
    "Box2D.Common.Math.b2Transform",
  ]);
...
(function () {
  ...
  flash.addDescription("Box2D.Common.Math.b2Sweep", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Common.Math.b2Sweep",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Common.Math.b2Transform", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Common.Math.b2Mat22",
  ]);
})();
(function () {
  ...
  d.IsValid = function () {
    return (
      Box2D.Common.Math.b2Math.IsValid(this.x) &&
      Box2D.Common.Math.b2Math.IsValid(this.y)
    );
  };
  var s = {};
  ...
  flash.addDescription("Box2D.Common.Math.b2Vec2", d, null, s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Common.Math.b2Math",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2ContactID", d, null, null, null, [
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2AABB", d, null, s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.b2AABB",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2TOIInput", d, null, null, null, [
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2ManifoldPoint", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.b2ContactID",
  ]);
})();
...
(function () {
  ...
  s.TimeOfImpact = function (input) {
    ...
    while (true) {
      ...
      Box2D.Collision.b2TimeOfImpact.s_distanceInput.transformA =
        Box2D.Collision.b2TimeOfImpact.s_xfA;
      Box2D.Collision.b2TimeOfImpact.s_distanceInput.transformB =
      ...
      Box2D.Collision.b2TimeOfImpact.s_fcn.Initialize(
        Box2D.Collision.b2TimeOfImpact.s_cache,
        proxyA,
        Box2D.Collision.b2TimeOfImpact.s_xfA,
        proxyB,
      ...
      separation = Box2D.Collision.b2TimeOfImpact.s_fcn.Evaluate(
        Box2D.Collision.b2TimeOfImpact.s_xfA,
        Box2D.Collision.b2TimeOfImpact.s_xfB,
      );
      if (separation <= 0.0) {
      ...
      if (iter == 0) {
        if (separation > radius) {
          target = Box2D.Common.Math.b2Math.Max(
            radius - tolerance,
            0.75 * radius,
          );
        } else {
      ...
      newAlpha = alpha;
      {
        ...
        f2 = Box2D.Collision.b2TimeOfImpact.s_fcn.Evaluate(
          Box2D.Collision.b2TimeOfImpact.s_xfA,
          Box2D.Collision.b2TimeOfImpact.s_xfB,
        );
        if (f2 >= target) {
        ...
        while (true) {
          ...
          f = Box2D.Collision.b2TimeOfImpact.s_fcn.Evaluate(
            Box2D.Collision.b2TimeOfImpact.s_xfA,
            Box2D.Collision.b2TimeOfImpact.s_xfB,
          );
        ...
        Box2D.Collision.b2TimeOfImpact.b2_toiMaxRootIters = flash.int(
          Box2D.Common.Math.b2Math.Max(
    ...
    Box2D.Collision.b2TimeOfImpact.b2_toiMaxIters = flash.int(
      Box2D.Common.Math.b2Math.Max(
        Box2D.Collision.b2TimeOfImpact.b2_toiMaxIters,
        iter,
      ),
    );
    return alpha;
  };
  flash.addDescription("Box2D.Collision.b2TimeOfImpact", d, null, s, null, [
    "Box2D.Collision.b2SimplexCache",
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2RayCastInput", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Collision.ClipVertex", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.b2ContactID",
  ]);
})();
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2WorldManifold", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Common.b2Settings",
    "Box2D.Collision.b2Manifold",
  ]);
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2ContactPoint", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.b2ContactID",
  ]);
})();
      ...
      QueryCallback = flash.bindFunction(this, function (proxy) {
        ...
        if (this.m_pairCount == this.m_pairBuffer.length) {
          this.m_pairBuffer[this.m_pairCount] =
            new Box2D.Collision.b2DynamicTreePair();
        }
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.Shapes.b2Shape", d, null, s, null, [
    "Box2D.Collision.b2DistanceInput",
    "Box2D.Collision.b2DistanceProxy",
    "Box2D.Collision.b2SimplexCache",
    "Box2D.Collision.b2DistanceOutput",
...
(function () {
  ...
  d.ComputeSubmergedArea = function (normal, offset, xf, c) {
    ...
    for (i = 0; i < this.m_vertexCount; ++i) {
      depths[i] =
        Box2D.Common.Math.b2Math.Dot(normalL, this.m_vertices[i]) - offsetL;
    ...
    intoVec = new Box2D.Common.Math.b2Vec2(
    ...
    outoVec = new Box2D.Common.Math.b2Vec2(
  ...
  d.SetAsVector = function (vertices, vertexCount) {
    ...
    for (i = 0; i < this.m_vertexCount; ++i) {
      ...
      edge = Box2D.Common.Math.b2Math.SubtractVV(
        this.m_vertices[i2],
        this.m_vertices[i1],
      );
    ...
    this.m_centroid = Box2D.Collision.Shapes.b2PolygonShape.ComputeCentroid(
      this.m_vertices,
      this.m_vertexCount,
    );
  };
  ...
  d.SetAsOrientedBox = function (hx, hy, center, angle) {
    ...
    xf.R.Set(angle);
    for (i = 0; i < this.m_vertexCount; ++i) {
      this.m_vertices[i] = Box2D.Common.Math.b2Math.MulX(
        xf,
        this.m_vertices[i],
      );
      this.m_normals[i] = Box2D.Common.Math.b2Math.MulMV(
        xf.R,
        this.m_normals[i],
      );
    }
  ...
  d.SetAsEdge = function (v1, v2) {
    ...
    this.m_normals[0] = Box2D.Common.Math.b2Math.CrossVF(
      Box2D.Common.Math.b2Math.SubtractVV(v2, v1),
      1.0,
    );
...
(function () {
  ...
  d.ComputeMass = function (massData, density) {
    massData.mass =
      density * Box2D.Common.b2Settings.b2_pi * this.m_radius * this.m_radius;
...
(function () {
  ...
  s.FindMaxSeparation = function (edgeIndex, poly1, xf1, poly2, xf2) {
    ...
    s = Box2D.Collision.b2Collision.EdgeSeparation(
      poly1,
      xf1,
      edge,
      poly2,
    ...
    sPrev = Box2D.Collision.b2Collision.EdgeSeparation(
      poly1,
      xf1,
      prevEdge,
      poly2,
    ...
    sNext = Box2D.Collision.b2Collision.EdgeSeparation(
      poly1,
      xf1,
      nextEdge,
      poly2,
  ...
  s.CollidePolygons = function (manifold, polyA, xfA, polyB, xfB) {
    ...
    separationA = Box2D.Collision.b2Collision.FindMaxSeparation(
    ...
    separationB = Box2D.Collision.b2Collision.FindMaxSeparation(
    ...
    Box2D.Collision.b2Collision.FindIncidentEdge(
      incidentEdge,
      poly1,
      xf1,
      edge1,
    ...
    np;
    np = Box2D.Collision.b2Collision.ClipSegmentToLine(
      clipPoints1,
      incidentEdge,
      tangent2,
      sideOffset1,
  ...
  flash.addDescription("Box2D.Collision.b2Collision", d, null, s, null, [
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.b2Manifold",
    "Box2D.Common.b2Settings",
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2OBB", d, null, null, null, [
    "Box2D.Common.Math.b2Mat22",
    "Box2D.Common.Math.b2Vec2",
  ]);
})();
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2DistanceProxy", d, null, null, null, [
    "Box2D.Collision.Shapes.b2Shape",
    "Box2D.Collision.Shapes.b2CircleShape",
    "Box2D.Common.Math.b2Vec2",
    "Box2D.Collision.Shapes.b2PolygonShape",
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2RayCastOutput", d, null, null, null, [
    "Box2D.Common.Math.b2Vec2",
  ]);
})();
(function () {
  ...
  s.Distance = function (output, cache, input) {
    ...
    while (iter < k_maxIters) {
      ...
      vertex.indexA = flash.int(
        proxyA.GetSupport(
          Box2D.Common.Math.b2Math.MulTMV(transformA.R, d.GetNegative()),
        ),
      );
      vertex.wA = Box2D.Common.Math.b2Math.MulX(
        transformA,
        proxyA.GetVertex(vertex.indexA),
      );
      vertex.indexB = flash.int(
        proxyB.GetSupport(Box2D.Common.Math.b2Math.MulTMV(transformB.R, d)),
      );
      vertex.wB = Box2D.Common.Math.b2Math.MulX(
        transformB,
    ...
    Box2D.Collision.b2Distance.b2_gjkMaxIters = flash.int(
      Box2D.Common.Math.b2Math.Max(
        Box2D.Collision.b2Distance.b2_gjkMaxIters,
        iter,
      ),
    );
    simplex.GetWitnessPoints(output.pointA, output.pointB);
    output.distance = Box2D.Common.Math.b2Math
    ...
    if (input.useRadii) {
      ...
      if (output.distance > rA + rB && output.distance > Number.MIN_VALUE) {
        ...
        normal = Box2D.Common.Math.b2Math.SubtractVV(
          output.pointB,
          output.pointA,
        );
        normal.Normalize();
  ...
  flash.addDescription("Box2D.Collision.b2Distance", d, null, s, null, [
...
(function () {
  ...
  d.Initialize = function (cache, proxyA, transformA, proxyB, transformB) {
    ...
    if (count == 1) {
      ...
      this.m_axis = Box2D.Common.Math.b2Math.CrossVF(
        Box2D.Common.Math.b2Math.SubtractVV(localPointA2, localPointA1),
        1.0,
      );
      this.m_axis.Normalize();
      tVec = this.m_axis;
      ...
      this.m_axis = Box2D.Common.Math.b2Math.CrossVF(
        Box2D.Common.Math.b2Math.SubtractVV(localPointB2, localPointB1),
        1.0,
      );
      this.m_axis.Normalize();
      tVec = this.m_axis;
      ...
      dA = Box2D.Common.Math.b2Math.MulMV(
        transformA.R,
        Box2D.Common.Math.b2Math.SubtractVV(localPointA2, localPointA1),
      );
      pB = Box2D.Common.Math.b2Math.MulX(transformB, localPointB);
      dB = Box2D.Common.Math.b2Math.MulMV(
        transformB.R,
        Box2D.Common.Math.b2Math.SubtractVV(localPointB2, localPointB1),
      );
...
(function () {
  ...
  flash.addDescription("Box2D.Collision.b2Manifold", d, null, s, null, [
...
(function () {
  ...
  d.RemoveLeaf = function (leaf) {
    ...
    if (node1) {
      ...
      while (node1) {
        oldAABB = node1.aabb;
        node1.aabb = Box2D.Collision.b2AABB.Combine(
          node1.child1.aabb,
          node1.child2.aabb,
        );
  ...
  flash.addDescription("Box2D.Collision.b2DynamicTree", d, null, null, null, [
    "Box2D.Common.b2Settings",
    "Box2D.Collision.b2DynamicTreeNode",
    "Box2D.Common.Math.b2Math",
    "Box2D.Collision.b2AABB",
...
(function () {
  ...
  d.GetMetric = function () {
    switch (this.m_count) {
      ...
      case 1:
        return 0.0;
      case 2:
        return Box2D.Common.Math.b2Math
          .SubtractVV(this.m_v1.w, this.m_v2.w)
          .Length();
      case 3:
        return Box2D.Common.Math.b2Math.CrossVV(
          Box2D.Common.Math.b2Math.SubtractVV(this.m_v2.w, this.m_v1.w),
          Box2D.Common.Math.b2Math.SubtractVV(this.m_v3.w, this.m_v1.w),
        );
      default:
        Box2D.Common.b2Settings.b2Assert(false);
        return 0.0;
  ...
  flash.addDescription("Box2D.Collision.b2Simplex", d, null, null, null, [
    "Box2D.Collision.b2SimplexVertex",
    "Box2D.Common.b2Settings",
    "Box2D.Common.Math.b2Math",
    "Box2D.Common.Math.b2Vec2",
